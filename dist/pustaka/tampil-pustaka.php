...
<div class="row">
    <div class="col-sm-2">
        <div class="form-group">
            ...
            ?>
                <button type="button" id="btn-tambah-pustaka" class="btn btn-primary"><span class="text"><i class="fas fa-book fa-sm"></i> Tambah Pustaka</span></button>
            <?php endif; ?>
        </div>
    </div>
</div>
            ...
            <div class="card">
                ...
                <div class="card bg-basic">
                    ...
                    <div class="card-body text-center">
                        ...
                        if ($_SESSION['level'] == 'Karyawan' or $_SESSION['level'] == 'karyawan') :
                        ?>
                            <button type="button" class="btn-detail-pustaka btn btn-outline-success" id_pustaka="<?php echo $data['id_pustaka']; ?>" kode_pustaka="<?php echo $data['kode_pustaka']; ?>"><span class="text"><i class="fas fa-mouse-pointer"></i></span></button>
                            <button type="button" class="btn-edit-pustaka btn btn-outline-warning" id_pustaka="<?php echo $data['id_pustaka']; ?>" kode_pustaka="<?php echo $data['kode_pustaka']; ?>"><span class="text"><i class="fas fa-edit"></i></span></button>
                            <a href="pustaka/hapus.php?id_pustaka=<?php echo $data['id_pustaka']; ?>&gambar_pustaka=<?php echo $data['gambar_pustaka']; ?>" class="btn-hapus btn btn-outline-danger"><i class="fa fa-trash"></i></a>
                        <?php endif; ?>
                        <?php
