                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn-edit btn btn-warning btn-circle" id_penulis="<?php echo $data['id_penulis']; ?>" kode_penulis="<?php echo $data['kode_penulis']; ?>"><i class="fas fa-edit"></i> Edit</button>
                                        <a href="pustaka/penulis/hapus-penulis.php?id_penulis=<?php echo $data['id_penulis']; ?>" class="btn-hapus btn btn-danger btn-circle"><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
