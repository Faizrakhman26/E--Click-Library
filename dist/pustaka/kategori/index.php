    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header py-3">
                ...
                <button class="btn-tambah btn btn-primary btn-icon-split"><span class="text">+ Tambah</span></button>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn-edit btn btn-warning btn-circle" id_kategori_pustaka="<?php echo $data['id_kategori_pustaka']; ?>" kode_kategori_pustaka="<?php echo $data['kode_kategori_pustaka']; ?>"><i class="fas fa-edit"></i> Edit</button>
                                        <a href="pustaka/kategori/hapus-kategori.php?id_kategori_pustaka=<?php echo $data['id_kategori_pustaka']; ?>" class="btn-hapus btn btn-danger btn-circle"><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
...
<script>
    ...
    $('.btn-edit').on('click', function() {
        ...
        $.ajax({
            ...
            method: 'post',
            data: {
                id_kategori_pustaka: id_kategori_pustaka
            },
            success: function(data) {
                $('#tampil_data').html(data);
