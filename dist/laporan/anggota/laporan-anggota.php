            ...
            <div class="card-body">
                <div id="filter_laporan" class="collapse show">
                    ...
                    <form method="post" id="form">
                        <div class="form-row">
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="kata_kunci" name="kata_kunci" placeholder="Masukan Nama, Email, Alamat atau Status">
                            </div>
                            <div class="col-sm-3">
                                <button type="button" id="btn-tampil" class="btn btn-outline-primary"><span class="text"><i class="fas fa-search fa-sm"></i> Cari</span></button>
                            </div>
                        </div>
                    </form>
                </div>
