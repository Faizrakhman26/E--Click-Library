...
<div class="card mb-4">
    <div class="card-body">
        <div class="table-responsive">
            ...
            <a href="laporan/pustaka/cetak-laporan.php?kata_kunci=<?php if (!empty($_POST["kata_kunci"])) echo $_POST["kata_kunci"]; ?>" target='blank' class="btn btn-primary btn-icon-split"><span class="text"><i class="fas fa-print fa-sm"></i> Print </span></a>
